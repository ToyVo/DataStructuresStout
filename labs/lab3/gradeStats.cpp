...
void printSummary(vector<string> st, vector<double> list, double mean, double std, double max);

int main()
{
	// (1) two vectors: a vector of string named as students for storing students' names
	// a vector of double named as grades for storing students' scores
...
//calculate std variation by adding up all values minus the average, square that
//and then divide everything by n, and finally square root everything
double findStdDev(vector<double> list)
{
