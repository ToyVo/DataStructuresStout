...
int main()                      
{
	...
	cout << endl << "*** Simple Testing for Linear search and Binary search ***" << endl << endl;
	
	counter = 0;
	int index10Linear = linearSearch(array1, arrayLength, 10);
	cout<< "linear search for key element 10 takes counter of "<< counter <<" and found in array1[" << index10Linear << "]" << endl;

	counter = 0;
	int index10Binary = binarySearch(array1, arrayLength,  10);
	cout<<"binarySearch for key element 10 takes counter of "<< counter<< " and found in array1[" << index10Linear << "]" << endl;

	
	// Uncomment to search for multiple values after linear and binary search debugged.
	...
	elapsedSeconds = TimeSpecToMilliSeconds(&end) - TimeSpecToMilliSeconds(&start);

	cout << "Time for linear search in milliseconds: " << elapsedSeconds << endl;
	cout << "The average number of comparisons per linear search is " << sum/numSearches << endl << endl;
	...
	cout << "The average number of comparisons per binary search is " << sum/numSearches << endl << endl;
...
//Precondition: data in sorted order and contains n elements. Searching data for number findValue
//Postcondition: returns index of findValue or -1 if not in data
//Insert code for algorithm developed in class
int binarySearch(int data[], int n, int findValue)
{	
	counter = 0;		//variable to count number of loops
