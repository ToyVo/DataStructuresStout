...
int main()
{
	...
	int op;
	while (1) {
		cout << "Select an option (1: Add, 2: Search, 3: Print, 4: Delete, 5: Terminate) = " << endl;
		...
		if (op == 5) break;
		...
		else if (op == 3) printHashTable(hashTable);
			...
			cout << "Wrong option! \n Options (1: Add, 2: Search, 3: Print, 4: Delete, 5: Terminate) = " << endl;
	}
