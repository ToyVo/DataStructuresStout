...
//Case 1 is that they are equal
	...
	if(e1==e2)
	{
		...
		points+=2;
		cout<<"operator== works when genes are equal +2 points equal: "<<points<<endl;
	}	
	else
...
//Can code determine that they are not equal +1
	...
	else
	{
		...
		points+=1;
		cout<<"operator== works when genes are NOT equal +1 points equal: "<<points<<endl;
	}	
//Can code determine reverse to be equal?
	...
	if(e5==e6)
	{
		...
		cout<<"Error: operator== failed when genes are equal but reversed"<<endl<<e5<<"should be equal to "<<e6<<endl;
...
//Test copy constructor
	...
	if(s1==s2)
	{
		cout<<"S2 was changed after copy constructor call and S1 changed also. Fix copy constructor to get 5 points"<<endl;
	}
	else	
	{
		cout<<"s1 and s2 not equal after copy constructor and change of s2 test: "<<(s1==s2)<<" get 5 points"<< endl;
		points+=5;
	}
...
//Test the operator= to make a deep copy
	...
	if(s4==s3)
	{
		cout<<"S3 was changed after operator= call and S4 changed also. Fix operator= to get 5 points"<<endl;
	}
	else	
	{
		cout<<"s1 and s2 not equal after operator= and change of s3 test: "<<(s1==s2)<<" get 5 points"<< endl;
		points+=5;
	}
