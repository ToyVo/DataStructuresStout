...
int main()
{
   ...
   if (catRatter == someone)  {   cout << "fail 1\n";  }
   else                       {  cout << "pass 1\n";  }
   
   if (dogger2 == someone)  {   cout << "fail 2\n";  }
   else                     {  cout << "pass 2\n";  }
   
   if (dogger3 == someone)  {   cout << "fail 3\n";  }
   else                     {  cout << "pass 3\n";  }
   
   if (someone2 == someone)  {   cout << "pass 4\n";  }
   else                     {  cout << "fail 4\n";  }
   
   if (someone == someone)  {   cout << "pass 5\n";  }
   else                     {  cout << "fail 5\n";  }
